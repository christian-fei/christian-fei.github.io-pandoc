...
build(input, {
  ...
  minify: true,
  whitelist: ['ml3','mh1','mh2','mh3','mh4','mh5','mh6','mh2','f4','f5','f6','link','white','black','ph3','intro-line','avenir','mb3','mb6','mb3','measure','fw6','mt0','f2','f-subheadline-l','ph5-ns','pv3','bg-black-10','mv3','w4', 'w2', 'mw4'],
  stripComments: true
}).then(result => {
